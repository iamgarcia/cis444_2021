...
ERROR_MSG = "The server was unable to fulfill the request."
...
# This gets executed by default by the browser if no page is specified So.. we redirect to the endpoint we want to load the base page
@app.route('/') # Endpoint
def index():
